...
![](/upload/Pasted%20image%2020230802172917.png ':size=60%')

![](/upload/Pasted%20image%2020230802172933.png ':size=60%')

![](/upload/Pasted%20image%2020230802172953.png ':size=60%')
...
![](/upload/Pasted%20image%2020230729211524.png ':size=60%')
...
![](/upload/Pasted%20image%2020230729211511.png ':size=60%')
...
![](/upload/Pasted%20image%2020230802174827.png ':size=60%')

![](/upload/Pasted%20image%2020230802174858.png ':size=60%')

计算中 $R$ 的行列式值：

$$\vert R\vert=\begin{vmatrix}1 & \cos\theta_{1,2}\\0 & \sin\theta_{1,2}\end{vmatrix}=\sin\theta_{1,2}$$

![](/upload/Pasted%20image%2020230802175022.png ':size=60%')
...
![](/upload/Pasted%20image%2020230802180418.png ':size=60%')
...
![](/upload/Pasted%20image%2020230802193354.png ':size=60%')
...
![](/upload/Pasted%20image%2020230802193405.png ':size=60%')
...
![](/upload/Pasted%20image%2020230802195649.png ':size=60%')