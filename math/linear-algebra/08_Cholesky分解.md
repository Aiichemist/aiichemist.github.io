...
正定矩阵都是对称方阵
![[attachments/Pasted image 20230802172917.png]]
![[attachments/Pasted image 20230802172933.png]]
![[attachments/Pasted image 20230802172953.png]]


Cholesky 分解把矩阵分解为一个下三角矩阵以及它的转置矩阵的乘积：
$$A=LL^T$$
![[attachments/Pasted image 20230729211524.png]]
...
![[attachments/Pasted image 20230729211511.png]]
...
![[attachments/Pasted image 20230802174827.png]]
![[attachments/Pasted image 20230802174858.png]]
计算中 $R$ 的行列式值：
$$\vert R\vert=\begin{vmatrix}1 & \cos\theta_{1,2}\\0 & \sin\theta_{1,2}\end{vmatrix}=\sin\theta_{1,2}$$
![[attachments/Pasted image 20230802175022.png]]
...
![[attachments/Pasted image 20230802180418.png]]
...
![[attachments/Pasted image 20230802193354.png]]
对$G$进行Cholesky分解得到：
$$G=R_G^TR_G$$
将$R_G$写成一排列向量：
...
![[attachments/Pasted image 20230802193405.png]]
以向量夹角余弦形式展开$G$中向量积：
...
![[attachments/Pasted image 20230802195649.png]]
