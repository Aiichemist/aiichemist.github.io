# 正交投影
![[attachments/Pasted image 20230725155453.png|625]]
## 标量投影
...
豪斯霍尔德反射：
![[attachments/Pasted image 20230726124748.png|250]]
...
## 一元线性回归
![[attachments/Pasted image 20230726130639.png|325]]
$$\hat{y}=\vec{x}(\vec{x}^T\vec{x})^{-1}\vec{x}^T\vec{y}$$
$残差\varepsilon=\vec{y}-\hat{y}$
## 二元线性回归
![[attachments/Pasted image 20230726131833.png|350]]
...
## 多元线性回归
![[attachments/Pasted image 20230726131818.png|325]]
