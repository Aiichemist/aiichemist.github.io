...
![](/upload/Pasted%20image%2020230907230009.png ':size=70%')
...
![](/upload/Pasted%20image%2020230907230224.png ':size=70%')
...
![](/upload/Pasted%20image%2020230907231011.png ':size=70%')
...
![](/upload/Pasted%20image%2020230907231309.png ':size=70%')
...
\end{cases}$$
![](/upload/Pasted%20image%2020230907231758.png ':size=70%')
...
![](/upload/Pasted%20image%2020230907232453.png ':size=70%')
![](/upload/Pasted%20image%2020230907232458.png ':size=70%')
...
![](/upload/Pasted%20image%2020230907232735.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908084628.png ':size=70%')

## 边缘概率：二元PDF偏积分
图 10 所示为二元概率密度函数 $f_{X,Y}(x,y)$ 曲面和边缘概率曲线的关系。
![](/upload/Pasted%20image%2020230908084723.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908085017.png ':size=70%')
上式可以简写为：
...
![](/upload/Pasted%20image%2020230908085307.png ':size=70%')
![](/upload/Pasted%20image%2020230908085316.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908085452.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908091031.png ':size=70%')

图 16 比较 $f_X(x)$ 和 $y$ 取不同值时条件概率密度函数 $f_{X|Y}(x|y)$ 图像。将这些曲线投影到同一个平面，得到图 17。注意，图 17 中所有曲线和横轴围成图形的面积都是 $1$。
![](/upload/Pasted%20image%2020230908091127.png ':size=70%')
![](/upload/Pasted%20image%2020230908091135.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908092055.png ':size=70%')
![](/upload/Pasted%20image%2020230908094846.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908092421.png ':size=70%')
![](/upload/Pasted%20image%2020230908092431.png ':size=70%')

## 以鸢尾花数据为例：不考虑分类标签
本章以下两节还是用鸢尾花数据集花萼长度 ($X_1$)、花萼宽度 ($X_2$)、分类标签 ($Y$) 为例，讲解本章前文介绍连续随机变量主要知识点。图 24 所示为不考虑分类时，鸢尾花样本数据花萼长度、花萼宽度散点图。
![](/upload/Pasted%20image%2020230908092710.png ':size=70%')
![](/upload/Pasted%20image%2020230908092729.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908093028.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908093546.png ':size=70%')

图 27 所示为固定 $x_2$ 时，概率密度函数$f_{X_1,X_2}(x_1,x_2)$ 随 $x_1$ 变化。图 26 (b) 中直线和整个水平轴围成的面积对应边缘概率 $f_{X_2}(x_2 = c)$。
![](/upload/Pasted%20image%2020230908093919.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908094413.png ':size=70%')
![](/upload/Pasted%20image%2020230908094818.png ':size=70%')

### 联合 PDF vs 边缘 PDF
图30 所示为联合 PDF 和边缘 PDF 之间关系。图中联合概率密度函数 $f_{X_1,X_2}(x_1,x_2)$ 采用高斯 KDE 估计得到。图 30 中的 $f_{X_1,X_2}(x_1,x_2)$ 比较精准地捕捉到了鸢尾花样本数据的分布特征。
![](/upload/Pasted%20image%2020230908095910.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908100204.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908101807.png ':size=70%')
![](/upload/Pasted%20image%2020230908101816.png ':size=70%')
![](/upload/Pasted%20image%2020230908101835.png ':size=70%')
![](/upload/Pasted%20image%2020230908102423.png ':size=70%')
![](/upload/Pasted%20image%2020230908102434.png ':size=70%')
![](/upload/Pasted%20image%2020230908102445.png ':size=70%')

## 以鸢尾花数据为例：考虑分类标签
本节将以鸢尾花标签为条件讨论条件概率。图 38 所示为考虑分类标签的鸢尾花数据散点图。
![](/upload/Pasted%20image%2020230908102510.png ':size=70%')
### 给定分类标签 $Y = C_1 (setosa)$
...
![](/upload/Pasted%20image%2020230908114111.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908115018.png ':size=70%')
![](/upload/Pasted%20image%2020230908115042.png ':size=70%')
![](/upload/Pasted%20image%2020230908115059.png ':size=70%')
...
![](/upload/Pasted%20image%2020230908115610.png ':size=70%')

最后，比较离散和连续随机变量
![](/upload/Pasted%20image%2020230908115830.png ':size=70%')
![](/upload/Pasted%20image%2020230908115754.png ':size=70%')
